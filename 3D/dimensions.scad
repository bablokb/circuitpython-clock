...
// dimensions for support-part   ---------------------------------------------

y_support_bot   = y1_panel/3;
y_support_top   = y_support_bot*2/3;
y_support_shift = (y_support_bot-y_support_top)/2;
h_support       = z_body + 20;
